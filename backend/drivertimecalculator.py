...
class DriverTimeCalculator:
    def __init__(self):
        ...
        self.small_break = 45 * 60
        self.big_break = 11 * 60 * 60
        self.full_day = 24 * 60 * 60  # seconds per day
        self.driver = Driver()
    ...
    def calculate_time(self, driver_id, calculated_route_duration):
        ...
        needed_full_days = int(calculated_route_duration / self.drivable_seconds_per_day)
